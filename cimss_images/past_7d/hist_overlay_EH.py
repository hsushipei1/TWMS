...
while startd <= endd:
	...
	for hh in subt:
		...
		# Overlaying
		os.system("convert -size 1965x1242 xc:black ./"+proc_dir+"/bk_"+strd_str+"."+hh+".png")
		os.system("convert -composite -geometry +0+277.1 ./"+proc_dir+"/bk_"+strd_str+"."+hh+".png \
					./"+proc_dir+"/cropped_io_"+strd_str+"."+hh+".GIF ./"+proc_dir+"/out1_"+strd_str+"."+hh+".png")
		os.system("convert -composite -geometry +872+555.1 ./"+proc_dir+"/out1_"+strd_str+"."+hh+".png \
					./"+proc_dir+"/cropped_wau_"+strd_str+"."+hh+".GIF ./"+proc_dir+"/out2_"+strd_str+"."+hh+".png")
		os.system("convert -composite -geometry +889+0 ./"+proc_dir+"/out2_"+strd_str+"."+hh+".png \
					./"+proc_dir+"/cropped_wnp_"+strd_str+"."+hh+".GIF ./"+proc_dir+"/out3_"+strd_str+"."+hh+".png")
		os.system("convert -composite -geometry +1111+555 ./"+proc_dir+"/out3_"+strd_str+"."+hh+".png \
					./"+proc_dir+"/cropped_eau_"+strd_str+"."+hh+".GIF ./overlaid/overlaid_"+case+"_"+strd_str+"."+hh+".png")
