...
# Configuration
var = "v" ############
match_word = "':VGRD:....*mb:'" # in grib2 GFS data, #############
...
#os.system(WGRIB2+" "+gfs_data_dir+"/gfs."+data_time+".pgrb2.1p00.f000_f384.grib2 -netcdf "+gfs_data_dir+"/"+middle_file+" -match "+match_word) # 2D variable
os.system(WGRIB2+" "+gfs_data_dir+"/gfs."+data_time+".pgrb2.1p00.f000_f384.grib2 -nc_nlev 26 -nc4 -netcdf "+gfs_data_dir+"/"+middle_file+" -match "+match_word) # 3D variable
